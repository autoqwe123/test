...
class Client(Iface):
    ...
    def getContactsV2(self, ids):
        ...
        """
        self.send_getContactsV2(ids)
        return self.recv_getContactsV2()

    def send_getContactsV2(self, ids):
...
class Processor(Iface, TProcessor):
    ...
    def process_getContactsV2(self, seqid, iprot, oprot):
        ...
        result = getContactsV2_result()
        try:
            result.success = self._handler.getContactsV2(args.ids)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
