...
class ContactUserStatus(object):
    NORMAL = 0
    UNBOUND = 1
    UNREGISTERED = 2
...
class Message(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i31 in range(_size27):
                        ...
                        self.contentMetadata[_key32] = _val33
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 19:
    ...
    def write(self, oprot):
        ...
        if self.contentMetadata is not None:
            ...
            for kiter40, viter41 in self.contentMetadata.items():
...
class GroupExtra(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i54 in range(_size50):
                        ...
                        self.inviteeMids[_key55] = _val56
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.memberMids is not None:
            ...
            for kiter57, viter58 in self.memberMids.items():
...
class ChatExtra(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ChatExtra')
...
class GetAllChatMidsResponse(object):
            ...
            if fid == 1:
                if ftype == TType.SET:
                    ...
                    for _i79 in range(_size75):
                        ...
                        self.memberChatMids.add(_elem80)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.SET:
                    ...
                    for _i85 in range(_size81):
                        ...
                        self.invitedChatMids.add(_elem86)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.memberChatMids is not None:
            ...
            for iter87 in self.memberChatMids:
        ...
        if self.invitedChatMids is not None:
            ...
            for iter88 in self.invitedChatMids:
...
class CreateChatRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i93 in range(_size89):
                        ...
                        self.targetUserMids.add(_elem94)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.targetUserMids is not None:
            ...
            for iter95 in self.targetUserMids:
...
class ContactCalendarEvents(object):
                ...
                if ftype == TType.MAP:
                    ...
                    for _i100 in range(_size96):
                        ...
                        for _i107 in range(_size103):
                            _elem108 = ContactCalendarEvent()
                            _elem108.read(iprot)
                            _val102.append(_elem108)
                        iprot.readListEnd()
                        self.events[_key101] = _val102
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.events is not None:
            ...
            for kiter109, viter110 in self.events.items():
                oprot.writeI32(kiter109)
                oprot.writeListBegin(TType.STRUCT, len(viter110))
                for iter111 in viter110:
                    iter111.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class GetContactsV2Response(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i116 in range(_size112):
                        ...
                        _val118 = ContactEntry()
                        _val118.read(iprot)
                        self.contacts[_key117] = _val118
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.contacts is not None:
            ...
            for kiter119, viter120 in self.contacts.items():
...
class InviteIntoChatRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i125 in range(_size121):
                        ...
                        self.targetUserMids.add(_elem126)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.targetUserMids is not None:
            ...
            oprot.writeSetBegin(TType.STRING, len(self.targetUserMids))
            for iter127 in self.targetUserMids:
...
class DeleteOtherFromChatRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i132 in range(_size128):
                        ...
                        self.targetUserMids.add(_elem133)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.targetUserMids is not None:
            oprot.writeFieldBegin('targetUserMids', TType.SET, 3)
            oprot.writeSetBegin(TType.STRING, len(self.targetUserMids))
            for iter134 in self.targetUserMids:
...
class CancelChatInvitationRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i139 in range(_size135):
                        ...
                        self.targetUserMids.add(_elem140)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.targetUserMids is not None:
            oprot.writeFieldBegin('targetUserMids', TType.SET, 3)
            oprot.writeSetBegin(TType.STRING, len(self.targetUserMids))
            for iter141 in self.targetUserMids:
...
all_structs.append(ChatExtra)
ChatExtra.thrift_spec = (
    None,  # 0
...
Chat.thrift_spec = (
    ...
    (8, TType.STRUCT, 'extra', [ChatExtra, None], None, ),  # 8
)
...
ContactCalendarEvents.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'events', (TType.I32, None, TType.LIST, (TType.STRUCT, [ContactCalendarEvent, None], False), False), None, ),  # 1
)
